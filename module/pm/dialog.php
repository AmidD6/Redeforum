...
if (!$Count[0]) MessageSend(2, 'У вас немає діалогів', '/user');
...
?>
<div class="Page">
<br><br><a style="width: 250px; margin-left: 340px;" href="/user" class="button ProfileB">Користувачі для спілкування</a>
<?php 
...
if ($Row['send'] == $_SESSION['USER_ID']) $delete = ' | <a href="/pm/control/delete/dialog/id/'.$Row['id'].'" class="lol">Видалити</a>';
else $delete = '';
...
echo '<div class="ChatBlock"><span>'.$Status.$delete.'</span><a href="/pm/message/id/'.$Row['id'].'" class="lol">Діалог з '.$User['login'].'</a></div>';
}
