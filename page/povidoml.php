...
<div class="container" style="background-color: #0b111e;  border-radius: 6px; box-shadow: 1px 1px 10px #000;">
 ...
 <ul class="nav nav-tabs nav-justified" style="">
    <li class="nav-item">
      <a class="nav-link active" data-toggle="tab" style="color: #78218f; text-shadow: 1px 1px 10px #000;" href="#home">Непрочитані</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab"  style="color: #78218f; text-shadow: 1px 1px 10px #000;" href="#menu1">Прочитані</a>
    </li>
